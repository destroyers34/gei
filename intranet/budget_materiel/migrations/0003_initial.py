...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'budget_materiel_fournisseur', (
            ...
            ('categorie', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['budget_materiel.Categorie'], null=True)),
        ))
    ...
    models = {
        ...
        u'budget_materiel.fournisseur': {
            ...
            'categorie': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['budget_materiel.Categorie']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
