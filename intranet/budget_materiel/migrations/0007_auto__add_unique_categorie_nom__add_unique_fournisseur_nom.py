...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Categorie', fields ['nom']
        db.create_unique(u'budget_materiel_categorie', ['nom'])

        # Adding unique constraint on 'Fournisseur', fields ['nom']
        db.create_unique(u'budget_materiel_fournisseur', ['nom'])


    def backwards(self, orm):
        # Removing unique constraint on 'Fournisseur', fields ['nom']
        db.delete_unique(u'budget_materiel_fournisseur', ['nom'])

        # Removing unique constraint on 'Categorie', fields ['nom']
        db.delete_unique(u'budget_materiel_categorie', ['nom'])
    ...
    models = {
        u'budget_materiel.categorie': {
            ...
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '60'})
        },
