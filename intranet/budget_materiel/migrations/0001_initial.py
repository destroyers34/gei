...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'budget_materiel_categorie', (
            ...
            ('nom', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60)),
        ))
        ...
        db.create_table(u'budget_materiel_materiel_eugenie', (
            ...
            ('fournisseur',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['budget_materiel.Fournisseur'], null=True)),
    ...
    models = {
        ...
        u'budget_materiel.materiel_eugenie': {
            ...
            'fournisseur': ('django.db.models.fields.related.ForeignKey', [],
                            {'to': u"orm['budget_materiel.Fournisseur']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
