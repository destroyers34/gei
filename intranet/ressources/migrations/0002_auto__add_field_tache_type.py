...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tache.type'
        db.add_column(u'ressources_tache', 'type',
                      self.gf('django.db.models.fields.CharField')(default='PO', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tache.type'
        db.delete_column(u'ressources_tache', 'type')
